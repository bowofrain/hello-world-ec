    ...
    <div id="menu">
        <ul>
                 ...
                 &nbsp; 
                  ...
                  href="javascript:void(null)" ><img src="images/operator/li.jpg" />&nbsp;&nbsp;&nbsp;<span style="font-weight: 600;font-size: 13">用户列表</span></a>
                  </li>
            ...
            <li><img src="images/operator/li.jpg" />&nbsp;&nbsp;&nbsp;<a href="operator/AddChgPile.jsp" target="main"><span style="font-weight: 600;font-size: 13">查询用户</span></a></li>
        </ul>
    </div>
</div>
</body>
