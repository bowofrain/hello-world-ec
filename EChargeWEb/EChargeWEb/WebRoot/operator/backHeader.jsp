...
$(document).ready(function() {
  ...
  <body>
<div id="all">
	<div id="banner"><h1>&nbsp;&nbsp;&nbsp;&nbsp;Echarge客服管理系统</h1></div>
    <div id="nav">
    	<ul>
        	
			<li class="inactive" id="sheet"><a href="operator/backData.jsp" target="menu">数据统计</a></li>
            <li class="inactive" id="log"><a href="operator/backData.jsp" target="menu">收费标准管理</a></li>
            <li class="inactive" id="chgpile"><a href="operator/backStation.jsp" target="menu">充电站管理</a></li>
            <li class="inactive" id="user"><a href="operator/backChgPile.jsp" target="menu">充电桩管理</a></li>
            <li class="active" id="operator"><a href="operator/backData.jsp" target="menu">客户服务</a></li>
