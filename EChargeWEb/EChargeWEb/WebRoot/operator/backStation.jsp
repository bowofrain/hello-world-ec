    ...
    <div id="menu">
        <ul>
                 ...
                 &nbsp; 
                  ...
                  href="javascript:void(null)" ><img src="images/operator/li.jpg" />&nbsp;&nbsp;&nbsp;<span style="font-weight: 600;font-size: 13">充电站列表</span></a>
                  </li>
                   
             <div class="categoryitems">
            <li>&nbsp;&nbsp;&nbsp; <a href="operator/ShowAllStation" target="main">&nbsp;&nbsp;&nbsp;所&nbsp;&nbsp;有&nbsp;&nbsp;&nbsp;</a></li>
            
            </div>
            <li><img src="images/operator/li.jpg" />&nbsp;&nbsp;&nbsp;<a href="operator/AddStation.jsp" target="main"><span style="font-weight: 600;font-size: 13">添加充电站</span></a></li>
        </ul>
    </div>
</div>
</body>
