...
<div id="all">
    <div id="menu">
        <ul>
				<li><img src="images/operator/li.jpg" />&nbsp;&nbsp;&nbsp; 
				<a href="admin/AddOperator.jsp" target="main"> 
					<span style="font-weight: 600;font-size: 13">添加客服</span>
				</a>
				</li>
				<li><img src="images/operator/li.jpg" />&nbsp;&nbsp;&nbsp;
				<a href="admin/ShowAllOperator" target="main">
					<span style="font-weight: 600;font-size: 13">客服列表</span>
				</a>
				</li>
				<li><img src="images/operator/li.jpg" />&nbsp;&nbsp;&nbsp;
				<a href="#" target="main">
					<span style="font-weight: 600;font-size: 13">查询客服</span>
				</a>
				</li>
