...
public class UpdateStationInfo extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		T_Station StationInfo=sBiz.StationInfo(request.getParameter("SID"));
		
		request.setAttribute("tStation", StationInfo);
