...
public class ShowAllChgPile extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Page page = new Page(pageNum,10,cpBiz.AllChgPileCount());
		List<T_ChgPile> cpList=new ArrayList<T_ChgPile>();
		cpList=cpBiz.AllChgPile(page);
		
		request.setAttribute("ChgPileList", cpList);
		request.setAttribute("pageInfo", page);
		request.getRequestDispatcher("ShowAllChgPile.jsp").forward(request, response);
